...
if (commandOverride === false && fuelLevel > 20000 && engineIndicatorLight === 'green') {
    console.log("The shuttle is not ready to launch!");
} else if (commandOverride === true) {
    console.log("Yikes! With command override turned on the shuttle will launch regardless of how much gas you have and the status of the engine.  WATCH OUT!");
}
